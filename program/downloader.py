...
def song(_, message):
    ...
    try:
        ...
        rep = f"**🎧 الرافع @{BOT_USERNAME} اެݪمبࢪمج: @{OWNER_NAME} اެݪسۅٛࢪس: @{UPDATES_CHANNEL} **"
...
async def vsong(client, message):
    ...
    try:
        ...
        print(e)
    try:
        msg = await message.reply("📍 **🎧 الرافع @{BOT_USERNAME} اެݪمبࢪمج: @{OWNER_NAME} اެݪسۅٛࢪس: @{UPDATES_CHANNEL} ...**")
